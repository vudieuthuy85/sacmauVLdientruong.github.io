...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        /* =========================================================
           HEADER THÔNG TIN (HIỂN THỊ CẢ WEB VÀ PDF)
           ========================================================= */
        #main-header {
            width: 90%;
            margin-bottom: 1.5vw;
        ...
        #main-header h2 {
            ...
            font-size: 1.6vw;
            margin-bottom: 0.8vw;
            color: #FFEB3B; /* Màu vàng nổi bật trên nền tối */
        ...
        @media print {
            ...
            #main-header { width: 100%; margin-bottom: 12px; color: black; }
            #main-header h2 { font-size: 15px; color: black; margin-bottom: 10px;}
            #main-header p { font-size: 12px; color: black; margin-bottom: 6px; font-weight: bold; line-height: 1.2;}
    ...
    questionsData.forEach((qObj, qIndex) => {
        ...
        qObj.opts.forEach((optText, optIndex) => {
            ...
            optDiv.addEventListener("click", function () {
                if (qBlock.classList.contains("answered-correct")) return; 
